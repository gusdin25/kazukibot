...
const banner = cfonts.render(('GUSDIN|WHATSAPP|BOT'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
...
module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, uploadimg, start, info, success, banner, close }
