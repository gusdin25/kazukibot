...
exports.transfer= () => {
	return'*「🤔」hmmm\ncara: !transfer tag orang|jumlah\ncontoh : !transfer @gus|50000'
}

exports.noregis = () => {
	return`*「❗」BELUM DAFTAR*\n*cara daftar ${prefix}daftar nama|umur* \n\n*contoh ${prefix}daftar gusdin|18*`
}

exports.baned = () => {
	return`*「❗」SORRY SORRY AJA NIH BRO, TAPI KAU SUDAH KU BANNED , KALO MAU DI UNBAN BILANG OWNER https://wa.me/6281997826183 :V*`
}
